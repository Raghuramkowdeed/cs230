...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 15 18:41:05 2020
...
import torch
from transformers import BertModel, DistilBertConfig, BertPreTrainedModel
...
class DistilBertForToxic(BertPreTrainedModel):
    ...
    def forward(
        ...
        sequence_output=  outputs[2][-(self.bert_hidden_states):]      
        #sequence_output=  outputs[2][(self.bert_hidden_states-1)]      
